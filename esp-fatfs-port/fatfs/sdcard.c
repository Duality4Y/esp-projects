...
/*
    file part of port for Esp8266 fatfs
*/
...
#define CS_H() SET_CS(HIGH)
#define CS_L() SET_CS(LOW)
...
)
{
    ...
    for(i = 0; i < bc; i++)
    {
        buff[i] = (BYTE)spi_tx8(SPI_INTERFACE, 0xff);
    }
}
...
)
{
    ...
    dly_us(10000);          /* 10ms */
    spi_init(SPI_INTERFACE);
    spi_clock(SPI_INTERFACE, 50, 5);
